...
from es_data_load.lib.utilities import get_config, get_source
...
if __name__ == "__main__":
    parser_args = {
        ...
        "-c": {"help": "Elastic config file", "type": str, "argument_count": 1},
        "-t": {"help": "Test Source Query/Data", "type": int, "argument_count": 1},
    }
    cmdparser = argparse.ArgumentParser()
    for argument_flag, argument_settings in parser_args.items():
        cmdparser.add_argument(
            argument_flag,
            type=argument_settings["type"],
    ...
    # loadconfigs = PVLoadConfiguration.generate_load_configuration_from_folder(directories=[args.d[0]])
    loadconfigs = PVLoadConfiguration.load_default_pv_configuration(suffix="_test")
