...
def test_process_load_operation(load_job_configuration_1: LoadConfiguration, search, mysql_source, ):
    ...
    try:
        load_job.search_target.es.indices.delete(
            index=load_job_configuration_1.get_load_operation(name_load_job_to_process)['target_setting']['index'])
